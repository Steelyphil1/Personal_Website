        ...
        <React.Fragment>
            <Box display="flex">
                ...
                <Stack spacing={6} justifyContent="center" alignItems="center" textAlign="center" sx={{mt: 15, ml: 20, mr: 20}}>
                        <Typography variant="h3">{config.verbiage.work.title}</Typography>
                        <Typography variant="p" sx={{fontSize: {md: '2.5rem', xs: '2.rem'}}}>{config.verbiage.work.desc}</Typography>
                        <Typography variant="p" sx={{fontSize: {md: '2.5rem', xs: '2.rem'}}}>{config.verbiage.work.desc2}</Typography>
                </Stack>
            </Box>
        </React.Fragment>
    );
